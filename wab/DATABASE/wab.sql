...
CREATE TABLE IF NOT EXISTS `article _tbl` (
  ...
  `proposal_approved` int(1) DEFAULT NULL,
  `proposal_message` varchar(255) DEFAULT NULL,
  `article_posting_notification_via_email` int(1) NOT NULL,
  `send_whole_article_via_email` int(1) NOT NULL,
  `add_date` datetime NOT NULL,
  `update_date` varchar(45) DEFAULT NULL,
